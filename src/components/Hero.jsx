        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="mt-12 flex items-center gap-6">
              <a href="https://github.com/zeeshan335088-ai" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-gray-800 hover:bg-emerald-600 transition-colors">
