      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="/Zeeshan.png" target="_blank" rel="noopener noreferrer" className="px-4 py-2 bg-gradient-to-r from-emerald-600 to-cyan-600 rounded-lg hover:from-emerald-700 hover:to-cyan-700 transition-all font-medium text-sm border border-emerald-500/20">
              Open Resume
            </a>
          </div>
          ...
          <div className="flex md:hidden items-center">
            <button
              ...
              className="p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-emerald-500"
            >
              {isMenuOpen ? (
        ...
        <div className="md:hidden bg-gray-900 border-t border-gray-800">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <a 
              ...
              onClick={() => setIsMenuOpen(false)}
              className="block px-3 py-2 mt-2 rounded-md text-base font-medium bg-gradient-to-r from-emerald-600 to-cyan-600 text-white hover:from-emerald-700 hover:to-cyan-700 transition-all text-center"
            >
              Open Resume
            </a>
          </div>
